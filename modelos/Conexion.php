...
abstract class Conexion{
    ...
    private static function conectar(){
        try{
            ...
            self::$conexion = new PDO('informix:host=host.docker.internal; service=9088; database=final_ramos; server=informix; protocol=onsoctcp;EnableScrollableCursors = 1','informix','in4mix'); 
